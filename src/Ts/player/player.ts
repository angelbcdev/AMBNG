...
class Player extends Nodo {
  ...
  onCollision(attack: Nodo) {
    super.onCollision(attack);
    let defefense = attack.damage * (this.defense / 100);
...
// [playerAllAttacks.CANNON]: () => {
//  const damage = this.damage + this.damageExtra;
//  this.game.addNewEffect({
//    effect: ,
//    possition: {
//      x: this.possition.x + 25,
//      y: this.possition.y,
