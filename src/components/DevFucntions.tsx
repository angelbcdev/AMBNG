...
import { mapDetails } from "../newUI/backGround/backGroundShow";
      ...
      {showButons && (
        <div className="flex flex-col gap-2 overflow-scroll  h-[200px] pt-4 ">
          <div className="  ">
            ...
            {showBackground && (
              <div className="absolute top-0 -left-[300px] z-50 bg-slate-500/40 w-[300px] h-[300px] flex gap-16 overflow-scroll items-center px-10">
                  ...
                  return (
                    ...
                    >
                      <div
                        ...
                        className="w-[175px] relative left-3 h-[200px]"
                        onClick={() => {
          ...
          <button
            ...
            onClick={() => {
              const randomFloor = Math.floor(
                Math.random() * game.floors.length
              );
